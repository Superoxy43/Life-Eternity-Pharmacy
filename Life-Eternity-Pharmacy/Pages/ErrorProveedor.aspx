<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ErrorProveedor.aspx.cs" Inherits="Life_Eternity_Pharmacy.Pages.Error" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="alert-success">
        ...
        <p style="color: #000000">Click al botón regresar para volver a la lista de Proveedores</p>
    </div>
    <div>

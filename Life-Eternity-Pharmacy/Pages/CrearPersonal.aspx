<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CrearPersonal.aspx.cs" Inherits="Life_Eternity_Pharmacy.Pages.CrearPersonal" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">


    <h2 style="color: #3333FF; font-style: oblique;">Crear Personal</h2>
    ...
    <div>
        ...
        <div cssclass="table table-striped-columns">
            ...
            <a href="ListaPersonal.aspx" class="btn btn-secondary" style="border-style: ridge; color: #ffffff;">Cancelar</a>

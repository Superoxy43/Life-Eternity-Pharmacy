<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ErrorCategoria.aspx.cs" Inherits="Life_Eternity_Pharmacy.Pages.ErrorCategoria" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="alert-success">
        ...
        <p style="color: #000000">Click al botón regresar para volver a la lista de Categorías</p>
    </div>
    <div>

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditarCliente.aspx.cs" Inherits="Life_Eternity_Pharmacy.Pages.EditarCliente" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <h2 style="color: #3333FF; font-style: oblique;">Editar Cliente</h2>
    ...
    <div>
        ...
        <div cssclass="table table-striped-columns">
            ...
            <a href="ListaCliente.aspx" class="btn btn-secondary">Cancelar</a>

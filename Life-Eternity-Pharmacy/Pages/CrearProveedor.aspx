<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CrearProveedor.aspx.cs" Inherits="Life_Eternity_Pharmacy.Pages.CrearProveedor" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">


    <h2 style="color: #3333FF; font-style: oblique;">Crear Proveedor</h2>
    ...
    <div>
        ...
        <div cssclass="table table-striped-columns">
            <asp:Button ID="BtnAgregar" runat="server"
                ...
                <a href="ListaProveedor.aspx" class="btn btn-secondary" style="border-style: ridge; color: #ffffff;">Cancelar</a>
